...
<script type="text/javascript">
	...
	function requestPay() {
		...
		//결제 
		let paymentPrice = $("form[name=payForm] input[name=paymentPrice]")
				.val();
		alert(paymentPrice);
			...
			<div class="pay-content">
					...
					<div class="pay-content-detail">
						...
						<div class="pay-detail-desc">
							<div class="pay-detail-desc-row">
								...
								<div class="pay-detail-desc-con">
									<input type="text" style="width: 6rem;" name="payDate"
										value="${now}"> ~ <input type="text"
										style="width: 6rem;" name="endDate" value="${enddate}">
								</div>
							</div>
						</div>
						<div class="pay-detail-desc">
							<div class="pay-detail-desc-row">
								...
								<div class="pay-detail-desc-con">
									<input type="text" style="width: 20rem;" name="content"
										value="${dto2.content}">
								</div>
							</div>
						</div>
				...
				<div class="pay-content-footer">
					...
					<button type="button" class="back"
						onclick="location.href='${pageContext.request.contextPath}/pay/list'">결제취소</button>
				</div>
			</div>
		</div>
