...
window.addEventListener("load",function(){
	...
	document.querySelector(".dataCount").innerHTML = dataCount+"개("+page+"/"+total_page+
			"페이지)";
		...
		<div class="body-main">
			...
			<div class="row board-list-footer">
				...
				<div class="col text-end">
					<button type="button" class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/board/write';">글올리기</button>
				</div>
			</div>
