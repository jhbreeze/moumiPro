			...
			<div class="modal-body pt-1">
				...
				<section class="modal-body-1 mt-2 mb-4 pt-1 ps-2 pe-2 pb-2">
					...
					<div class="d-flex mb-1">
						<div class="align-middle">
							...
							<img class="m-1 me-2" style="height: 36px; width: 36px;"
				...
				<section class="modal-body-1 p-3 mb-3">
					<div class="d-flex">
						...
						<div class="pb-2">
							<label class="fw-bold">MOUMI</label><br> 안녕하세요, <b>MOUMI</b>입니다 :) <br> 
								궁금하신 사항을 남겨주시면 <br> 자세히 안내 드릴게요!
						</div>
					</div>
					<div class="pb-2">
					...
					<div class="text-center callfont pt-2">운영시간 평일 9:00 ~ 18:00</div>
				</section>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="chatModalToggle2" aria-hidden="true"
	aria-labelledby="chatModalToggleLabel2" tabindex="-1"
	data-bs-backdrop="static">
	<div class="modal-dialog" style="width: 400px;">
		<div class="modal-content">
			<div class="modal-header">
				<div class="mb-2">
					<h4 class="modal-title" id="chatModalToggleLabel">
						<a data-bs-target="#chatModalToggle" data-bs-toggle="modal"> <i
			...
			<div class="modal-body" style="background-color: white;">
				<div class="content-frame">
					...
					<div class="mt-2">
						<input type="text" id="chatMsg" class="form-control msg-box"
