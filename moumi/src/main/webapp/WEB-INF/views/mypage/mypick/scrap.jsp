...
<p class="text-end p-1 pb-0 fw-bold">
	전체 <span style="color: green">${dataCount}</span>건
</p>
	...
	<tbody class="text-center">
		<c:forEach var="dto" items="${scrap}" varStatus="status">
			<tr class="pickScrap-table-tr">
				...
				<td colspan="4"><a
					href="${pageContext.request.contextPath}/board/article?communityNum=${dto.communityNum}&page=1">${dto.subject}</a></td>
				<td>${dto.nickName}</td>
				<td>${dto.regDate}</td>
		</c:forEach>
	</tbody>
